...
# Release 1.1
# PLEASE HOLD OFF INSTALLING THIS AS GOOGLE HAVE RELEASED A NEW VERSION OF THE API SO THIS VERSION WILL STOP WORKING SOON. I AM WORKING ON A NEW RELEASE WHICH SHOULD BE AVAILABLE IN THE NEXT FEW DAYS
